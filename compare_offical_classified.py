...
for file in files:      
    rel_count = 0
    irr_count = 0
    for line in codecs.open(r"{}/{}".format(classified_dir, file), "r", encoding="utf8"):
...
official_data = [json.loads(line) for line in codecs.open(official_file, "r", encoding="utf8")]
